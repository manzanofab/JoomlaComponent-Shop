...
class AlisHelper
{
	...
	public static function addSubmenu($vName = '')
	{
		...
		JSubMenuHelper::addEntry(
			JText::_('COM_ALIS_TITLE_ALIS'),
			'index.php?option=com_alis&view=alis',
			$vName == 'alis'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_ALIS_SUBMENU_CATEGORIES'),
			'index.php?option=com_categories&extension=com_alis',
			$vName == 'categories');
	}
	...
	*/
	public static function filterText($text)
	{
		...
		$config		= JComponentHelper::getParams('com_alis');
		$user		= JFactory::getUser();
