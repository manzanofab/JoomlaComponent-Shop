 ...
 * ali Table class
 */
class AlisTableAli extends JTable
{
    /**
     * Constructor
     *
    ...
    {
        parent::__construct('#__alis', 'id', $db);
    }
    ...
    {
        if (trim($this->title) == '') {
            $this->setError(JText::_('COM_ALIS_WARNING_PROVIDE_VALID_NAME'));
            return false;
        }
    ...
    public function store($updateNulls = false)
    {
        ...
        if ($this->id) {
            ...
            // New ali. An ali created and created_by field can be set by the user,
        ...
        $table = JTable::getInstance('Ali','AlisTable');
        if ($table->load(array('alias'=>$this->alias,'catid'=>$this->catid)) && ($table->id != $this->id || $this->id==0)) {
            $this->setError(JText::_('JLIB_DATABASE_ERROR_ALI_UNIQUE_ALIAS'));
            return false;
        }
